...
def create_notebook_rst_files(branchname):
    ...
    .. note::
        ...
        Please `get in touch with Ashley Smith <https://swarm-vre.readthedocs.io/en/latest/help.html>`_ if you would like a live demo or want some help! (or if you are able to contribute - ideas are also welcome!)

        The views to these notebooks are embedded directly from `Treebeard <https://treebeard.io>`_ (a CI tool for notebooks)
        ...
        | `View on Treebeard <https://treebeard.io/admin/Swarm-DISC/Swarm_notebooks/{branchname}>`_
        | `Alternative view with nbviewer <https://nbviewer.jupyter.org/github/Swarm-DISC/Swarm_notebooks/tree/{branchname}/notebooks/{nbname}.ipynb>`_
