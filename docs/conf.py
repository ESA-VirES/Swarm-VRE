...
def create_notebook_rst_files(branchname):
    ...
    .. note::
        ...
        | Notebook source: `Swarm-DISC/Swarm_notebooks <https://github.com/Swarm-DISC/Swarm_notebooks/tree/{branchname}>`_; Output views `generated by Treebeard <https://treebeard.io/admin/Swarm-DISC/Swarm_notebooks/{branchname}>`_
